  ...
  onReturnHome,
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4 animate-fade-in">
            <div className="relative w-full max-w-md bg-[#0a0319] border-4 border-[#00f0ff] shadow-[8px-8px-0px-#000] p-5 sm:p-6 flex flex-col items-center text-center">
                ...
                <div className="w-full flex items-center justify-between bg-[#05010d] border-2 border-[#2b184f] p-2.5 my-3">
                    <div className="flex flex-col items-start">
                        <span className="text-[7px] font-['Press-Start-2P'] text-slate-400">DIFFICULTY:</span>            
                        <span className="text-[9px] font-['Press-Start-2P'] font-bold mt-1 px-1.5 py-0.5"
                            style={{
                    ...
                    <span className="text-[8px] font-['Press-Start-2P'] text-slate-400">RANK:</span>           
                    <div
            ...
            <div  className="w-full bg-[#05010d] border-2 border-[#2b184f] p-3 flex flex-col gap-2 mb-4 text-left">
                <div className="flex justify-between items-center text-[9px] font-['Press-Start-2P']">
                   <span className="text-[#ffdca1]">FINAL SCORE:</span>            
               ...
               <div className="flex justify-between items-center text-[8.5px] font-['Press-Start-2P']">
                  <span className="text-slate-400">MISSION TIME:</span>            
                    <span className="text-[#00f0ff]">{timeFormatted}</span>          
                </div>
                <div className="flex justify-between items-center text-[8.5px] font-['Press-Start-2P']">
                   <span className="text-slate-400">PLANETS SURVEYED:</span>           
                    <span className="text-[#39ff14]">
                       {planetsDiscovered} / {totalPlanets}
                    </span>          
                </div>
                <div className="flex justify-between items-center text-[8.5px] font-['Press-Start-2P']">
                    <span className="text-slate-400">COSMIC GEMS:</span>            
                    <span className="text-[#ffaa00]">+{gemsCollected}</span>          
                </div>
                <div className="flex justify-between items-center text-[8.5px] font-['Press-Start-2P']">
